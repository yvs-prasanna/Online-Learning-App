...
async function seedDatabase() {
  ...
  try {
   await db.run(`INSERT or ignore INTO users (name, email, password_hash, mobile, target_exam, preferred_language, preparation_level) VALUES
...
console.log("Seeding users table completed");
  ...
  // 🌟 Educators
await db.run(`INSERT or ignore INTO educators (
  name, email, password_hash, mobile, qualification, experience, bio, rating, is_verified, image_url
) VALUES
...
`);
console.log('✅ Seeded data for educators');

// 🌟 Educator subjects
await db.run(`INSERT or ignore INTO educator_subjects (educator_id, subject) VALUES
  (1, 'Physics'),
  (1, 'Modern Physics'),
  (2, 'Computer Science'),
  (2, 'Data Structures'),
  ...
  (5, 'Organic Chemistry')
`);
console.log('✅ Seeded data for educator_subjects');

// 🌟 Courses
await db.run(`INSERT INTO courses (
  ...
  ('Complete Physics for JEE Main + Advanced', 'Covers all concepts from Mechanics to Modern Physics for JEE preparation.', 1, 'JEE', '6 months', '1 year', 120, 5999,
  ...
  ('Modern Physics Masterclass', 'Specialized course focusing on Modern Physics concepts.', 1, 'JEE', '3 months', '6 months', 60, 2999,
  '["60 video lessons","Numerical practice","Concept boosters","Live Q&A"]',
  '{"liveClasses": 60, "recordedVideos": 150, "mockTests": 15, "pdfNotes": true, "doubtSupport": true, "formulaSheets": 25}',
  1999, 'live', 'English', 'https://example.com/thumbs/modern-physics.jpg', 4.6, 9420),

  ('DSA Crash Course', 'Fast-paced course covering Data Structures and Algorithms.', 2, 'GATE', '2 months', '3 months', 50, 4999,
  ...
  ('Complete Computer Science Foundation', 'A detailed course covering core CS subjects.', 2, 'GATE', '6 months', '1 year', 100, 7999,
  ...
  ('NEET Biology Master Course', 'Biology concepts taught with a clinical perspective.', 3, 'NEET', '6 months', '1 year', 140, 6499,
  ...
  ('Medicine Foundation for NEET', 'Learn foundational medical concepts to excel in NEET.', 3, 'NEET', '4 months', '6 months', 80, 4999,
  ...
  ('Mathematics for Competitive Exams', 'Complete math course for JEE, GATE, and SSC.', 4, 'JEE', '5 months', '9 months', 100, 5999,
  ...
  ('Algebra and Calculus Core Concepts', 'In-depth focus on Algebra and Calculus topics.', 4, 'JEE', '3 months', '6 months', 60, 3499,
  ...
  ('Target JEE Chemistry Booster', 'Focused course to boost your JEE Chemistry score.', 5, 'JEE', '2 months', '3 months', 40, 2999,
  ...
  ('NEET Chemistry Masterclass', 'Complete Chemistry course for NEET covering organic chemistry', 1, 'NEET','6 months', '6 months', 50, 4999,
...
`);
console.log('✅ Seeded data for courses');

await db.run(`INSERT INTO course_chapters (course_id, title, description, order_index) VALUES
...
console.log("Seeding Course_chapters table completed");

await db.run(`INSERT or ignore INTO lessons (course_id, chapter_id, title, description, video_url, duration_seconds, order_index, is_free, resources) VALUES
...
`)
console.log("Completed Seeding lessons")

await db.run(`INSERT or ignore INTO enrollments (user_id, course_id, enrolled_at, expires_at, progress_percentage, last_accessed, is_active, purchase_price, payment_method)
VALUES
...
`)
console.log("seeding enrollments table complete")

await db.run(`INSERT or ignore INTO watch_history (user_id, lesson_id, watched_duration, total_duration, completed, last_watched_at, created_at) VALUES
...
(20, 34, 675, 690, TRUE, '2024-06-18 17:00:00', '2024-06-18 17:00:00');`)
  console.log("Seeding watch_history table complete")

await db.run(`INSERT or ignore INTO live_classes (course_id, educator_id, title, description, scheduled_at, duration_minutes, max_students, join_url, status)
VALUES
...
`)
console.log("Completed seeding database live_classes.")

await db.run(`INSERT or ignore INTO live_class_attendance (live_class_id, user_id, joined_at, left_at, duration_minutes) VALUES
...
`)
console.log('Seeding complete live_class_schedule')

await db.run(`INSERT or ignore INTO tests (course_id, title, description, type, subject, total_questions, duration_minutes, max_marks, negative_marking, difficulty, instructions) VALUES
...
`)
console.log('Seeding tests table')

await db.run(`INSERT or ignore INTO test_questions (test_id, question, options, correct_option, explanation, marks, negative_marks, subject, topic, difficulty) VALUES
...
`)
console.log("Completed Seeding testQuestions")
...
`)
console.log("Completed Seeding testAttempts")

await db.run(`INSERT or ignore INTO subscription_plans (
...
console.log("Completed seeding subscription_plans.");


await db.run(`INSERT or ignore INTO user_subscriptions (user_id, plan_id, started_at, expires_at, is_active, payment_amount, payment_method, payment_id, auto_renewal)
VALUES (1, 3, '2025-05-01 09:00:00', '2025-05-31 09:00:00', TRUE, 2999, 'credit_card', 'pay_ABC123', TRUE),
 ( 2, 2, '2025-05-10 10:00:00', '2025-06-09 10:00:00', TRUE, 999, 'debit_card', 'pay_DEF456', FALSE),
( 3, 1, '2025-01-01 08:00:00', '9999-12-31 00:00:00', TRUE, 0, NULL, NULL, FALSE),

( 5, 2, '2025-04-15 11:00:00', '2025-05-15 11:00:00', FALSE, 999, 'upi', 'pay_GHI789', FALSE),
( 6, 2, '2025-03-20 14:00:00', '2025-04-19 14:00:00', FALSE, 999, 'credit_card', 'pay_JKL012', FALSE),

( 7, 2, '2025-06-01 09:30:00', '2025-07-01 09:30:00', TRUE, 999, 'netbanking', 'pay_MNO345', TRUE),
( 12, 3, '2025-02-01 10:00:00', '2025-01-31 10:00:00', FALSE, 2999, 'upi', 'pay_PQR678', FALSE),

( 13, 1, '2024-12-01 08:00:00', '9999-12-31 00:00:00', TRUE, 0, NULL, NULL, FALSE),

( 15, 2, '2025-05-20 12:00:00', '2025-06-19 12:00:00', TRUE, 999, 'credit_card', 'pay_STU901', TRUE);`)
 console.log("Completed Seeding user_subscriptions.")


await db.run(`INSERT or ignore INTO doubts (user_id, course_id, lesson_id, question, attachments, status, priority, created_at, updated_at) VALUES
...
(3, 4, 5, 'Can you explain how paging works in operating systems?', '["https://cdn.example.com/uploads/os_paging_diagram.png"]', 'resolved', 'high', '2025-05-25 14:40:00', '2025-05-26 08:00:00'),

(5, 3, 17, 'Why do we prefer binary search over linear search?', NULL, 'answered', 'normal', '2025-06-03 13:20:00', '2025-06-03 13:45:00'),
...
(13, 4, 10, 'Why is multithreading important in modern applications?', NULL, 'answered', 'normal', '2025-05-18 11:55:00', '2025-05-18 12:10:00'),

(15, 10, 20, 'What are the important mechanisms in SN1 and SN2 reactions?', '["https://cdn.example.com/uploads/sn1-vs-sn2.pdf"]', 'pending', 'high', '2025-06-06 08:45:00', '2025-06-06 08:45:00'),
...
(15, 10, 25, 'Can you explain the Markovnikov’s rule with an example?', '["https://cdn.example.com/uploads/markovnikov.jpg"]', 'answered', 'high', '2025-06-08 11:30:00', '2025-06-08 12:00:00'),
...
(5, 3, 27, 'What’s the difference between stack memory and heap memory?', NULL, 'pending', 'normal', '2025-06-09 09:45:00', '2025-06-09 09:45:00'),
...
(2, 6, 25, 'What is the function of the hypothalamus in the human body?', NULL, 'pending', 'normal', '2025-06-10 17:00:00', '2025-06-10 17:00:00'),

(3, 4, 22, 'Explain the differences between compiler and interpreter.', NULL, 'resolved', 'low', '2025-06-11 10:10:00', '2025-06-11 10:45:00'),

(13, 4, 1, 'Is TCP faster than UDP? Why use TCP for HTTP?', NULL, 'answered', 'normal', '2025-06-11 12:50:00', '2025-06-11 13:20:00'),

(1, 8, 11, 'How do you solve cubic equations using factorization?', NULL, 'pending', 'normal', '2025-06-12 11:20:00', '2025-06-12 11:20:00'),
...
`);
console.log("Completed seeding doubts.")

await db.run(`
INSERT or ignore INTO doubt_answers (doubt_id, educator_id, answer, attachments, is_accepted, upvotes, downvotes, created_at) VALUES
...
(3, 2, 'Paging allows non-contiguous memory allocation, improving utilization and reducing fragmentation.', NULL, TRUE, 10, 1, '2025-05-26 09:00:00'),

(4, 3, 'Binary search is more efficient (O(log n)) but requires sorted data. Linear search works on unsorted data.', NULL, TRUE, 5, 0, '2025-06-03 14:00:00'),
...
(7, 2, 'Multithreading improves performance by parallelizing tasks on multi-core CPUs.', NULL, TRUE, 6, 0, '2025-05-18 12:15:00'),

(8, 2, 'Compiler translates the whole code before execution, interpreter runs it line-by-line.', NULL, TRUE, 4, 1, '2025-06-11 11:00:00'),

(9, 2, 'TCP is reliable and ordered, ideal for HTTP. UDP is faster but doesn’t guarantee delivery.', NULL, TRUE, 3, 0, '2025-06-11 13:30:00'),
...
`)
console.log("Completed seeding doubt_answers.");

await db.run(`INSERT or ignore INTO study_materials (course_id, chapter_id, title, description, type, file_url, file_size, download_count, is_downloadable, requires_subscription, created_at) VALUES
...
console.log("Completed seeding study_materials.")


await db.run(`INSERT or ignore INTO material_downloads (user_id, material_id, downloaded_at) VALUES
...
console.log("Completed seeding material_downloads.");

await db.run(`INSERT or ignore INTO course_reviews (user_id, course_id, rating, review, is_verified_purchase, helpful_count, created_at, updated_at) VALUES
...
console.log("Completed Course-reviews")

await db.run(`INSERT or ignore INTO educator_followers (user_id, educator_id, followed_at) VALUES
(1, 1, '2025-05-01 10:00:00'),  
(1, 4, '2025-05-01 10:30:00'),  
(2, 2, '2025-05-10 11:00:00'),  
(3, 3, '2025-01-05 09:20:00'), 
(5, 5, '2025-04-15 12:00:00'),  
(6, 1, '2025-03-21 10:10:00'), 
(7, 2, '2025-06-01 11:45:00'),  
(12, 1, '2025-02-01 09:30:00'), 
(13, 4, '2024-12-05 14:00:00'), 
(15, 3, '2025-05-20 12:30:00'); `);
console.log("Completed Educator-followers.")

await db.run(`INSERT or ignore INTO lesson_notes (user_id, lesson_id, timestamp_seconds, note, created_at, updated_at) VALUES

(1, 5, 90, 'Free body diagram explained clearly here.', '2025-06-01 10:05:00', '2025-06-01 10:05:00'),
(1, 7, 360, 'Important: Inclined plane friction trick at this timestamp.', '2025-06-01 10:15:00', '2025-06-01 10:15:00'),

(2, 17, 120, 'Endoplasmic reticulum types mentioned here.', '2025-06-03 09:10:00', '2025-06-03 09:10:00'),
(2, 20, 480, 'Golgi body function breakdown — very concise.', '2025-06-03 09:18:00', '2025-06-03 09:18:00'),

(6, 26, 200, 'Base case discussion and dry run starts.', '2025-06-05 16:00:00', '2025-06-05 16:00:00'),
(6, 30, 540, 'N-Queens explanation and constraints — remember this.', '2025-06-05 16:09:00', '2025-06-05 16:09:00'),

(6, 33, 150, 'Newtons 2nd Law F=ma — example with elevator.', '2025-06-06 08:30:00', '2025-06-06 08:30:00'),

(7, 19, 240, 'Plasma membrane model differences highlighted.', '2025-06-07 11:00:00', '2025-06-07 11:00:00'),

(12, 5, 300, 'Pulley trick with 2 masses — mark this.', '2025-06-08 14:20:00', '2025-06-08 14:20:00'),

(15, 25, 180, 'Named reaction: Cannizzaro explained.', '2025-06-09 10:00:00', '2025-06-09 10:00:00'),

(3, 11, 100, 'Recursive stack trace idea visualized.', '2025-06-04 17:00:00', '2025-06-04 17:00:00'),

(13, 12, 120, 'FCFS vs SJF scheduling logic starts here.', '2025-06-03 11:00:00', '2025-06-03 11:00:00');`);
console.log("Completed Lesson-notes.")

await db.run(`INSERT or ignore INTO user_achievements (user_id, achievement_type, achievement_data, earned_at) VALUES
...
console.log("Completed User-achievements.")


await db.run(`
INSERT or ignore INTO user_analytics (user_id, event_type, event_data, timestamp) VALUES
